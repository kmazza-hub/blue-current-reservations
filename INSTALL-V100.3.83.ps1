...
if ($CurrentVersion -ne "100.3.82") { throw "Expected certified V100.3.82; found V$CurrentVersion." }
...
$Files = @(
 ...
 "client\js\modules\productionReadiness.js", "client\js\pilot-readiness-closure-v100.3.83.js", "package.json", "package-lock.json",
 ...
 "scripts\maintenance\test-v100.3.79-navigation-readiness-authority.js", "scripts\maintenance\test-v100.3.80-persistent-navigation-system-readiness.js",
 "scripts\maintenance\test-v100.3.81-navigation-responsiveness.js", "scripts\maintenance\test-v100.3.82-window-navigation-authority.js",
 "scripts\maintenance\test-v100.3.83-pilot-readiness-closure.js", "scripts\maintenance\certify-v100.3.74-visible-sign-out.js",
 ...
 "scripts\maintenance\certify-v100.3.79-live-runtime-audit-closure.js", "scripts\maintenance\certify-v100.3.80-live-runtime-audit-closure.js",
 "scripts\maintenance\certify-v100.3.81-live-runtime-audit-closure.js", "scripts\maintenance\certify-v100.3.82-live-runtime-audit-closure.js",
 "scripts\maintenance\certify-v100.3.83-live-runtime-audit-closure.js", "INSTALL-V100.3.83.ps1", "README-V100.3.83.md"
)
...
npm ci
npm run check
if ($LASTEXITCODE -ne 0) { throw "V100.3.83 validation failed." }
npm run certify:pilot
if ($LASTEXITCODE -ne 0) { throw "V100.3.83 certification failed." }
...
Write-Host ""
Write-Host "V100.3.83 installed and certified." -ForegroundColor Green
