...
if ($CurrentVersion -ne "100.3.63") { throw "Expected certified V100.3.63; found V$CurrentVersion." }
...
$ApplicationFiles = @(
  ...
  "scripts\maintenance\certify-v100.3.64-team-scheduling-usability.js",
  "INSTALL-V100.3.64.ps1", "README-V100.3.64.md"
)
...
npm ci
npm run check
if ($LASTEXITCODE -ne 0) { throw "V100.3.64 validation failed." }
npm run certify:pilot
if ($LASTEXITCODE -ne 0) { throw "V100.3.64 certification failed." }
...
Write-Host ""
Write-Host "V100.3.64 installed and certified." -ForegroundColor Green
