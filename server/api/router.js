...
function createRouter({ database, auditService, idempotencyService, syncReconciliationService, telemetryService, reliabilityAutomationService, reservationService, realtimeHub, authService, floorService, reservationOperationsService, staffOperationsService, kitchenOperationsService, serviceCoordinationService, aiRestaurantBrainService, executiveCommandCenterService, autonomousOperationsService, guestIntelligenceService, workforceIntelligenceService, inventoryIntelligenceService, timeClockService, workforceFoundationService, schedulingService, employeePortalService, commandCenterService, operationsFeedService, actionListService, liveIntegrationService, repositoryImpactService, repositoryRetirementRehearsalService, retirementAssuranceService, retirementCandidateImpactService, v46ReleaseCertificationService, hospitalityPerformanceService, hospitalityActionWorkspaceService, serviceProfitabilityIntelligenceService, predictiveShiftControlService, managerOperatingRhythmService, multiLocationPerformanceService, pilotValueScorecardService, pilotProofProgramService, executivePilotReviewService, pilotDecisionLedgerService, expansionReadinessService, v48ReleaseCertificationService, rolloutActivationControlService, technicalActivationReadinessService, locationDeploymentPackageService, goLiveCommandService, launchStabilizationService, v49ReleaseCertificationService, productionOperationsHandoffService, productionHealthSupportService, productionIncidentCommandService, productionRecoveryReviewService, productionCorrectiveActionGovernanceService, v50ReleaseCertificationService, pilotOperationalReadinessService, restaurantDayLifecycleService, peakServiceStressTestService, dataIntegrityRecoveryService, rolePermissionCertificationService, operatorUxHardeningService, reservationGuestJourneyCertificationService, liveFloorServiceCertificationService, managementExecutiveAccuracyService, pilotDeploymentPackageService, pilotLaunchControlService, pilotExecutionObservationService, pilotStabilizationExitService, pilotCloseoutOutcomeService, expansionReplicationService, multiLocationExpansionControlService, expansionCohortObservationService, expansionPortfolioProofService, expansionRepeatabilityCertificationService, operationalIntegrationExpansionOrchestrationService, v52OperationalReadinessCertificationService, restaurantWorkflowIntegrationService, peakServiceWorkflowResilienceService, failureRecoveryShiftContinuityService, v53RestaurantOperationalCertificationService, operatorSpeedWorkflowSimplificationService, managerInterventionDecisionSpeedService, roleBasedServiceErgonomicsService, v54OperatorExperienceCertificationService, restaurantIntelligenceDecisionSupportService, profitabilityInterventionAccountabilityService, v55DecisionValueCertificationService, productionPilotEnvironmentReadinessService, pilotReleaseCandidateCertificationService, pilotLiveServiceAcceptanceService, finalProductReleaseCandidateService, finalHardeningRealEnvironmentService, productionLaunchCertificationService, productionMutationIntegrityService, productionBoundaryService, productionConfigurationService, persistenceMigrationReadinessService, persistenceSchemaMappingService, persistenceMigrationVerificationService, persistenceCutoverFrameworkService, persistenceBackfillService, migrationShadowStore, persistenceShadowExecutionService, persistenceReplicationCoordinatorService, operationalDataIntegrityService, restaurantWorkflowCertificationService, liveShiftFailureCertificationService, pilotReadinessCommandCenterService, operatorWorkflowCertificationService, universalHospitalityIntegrationService, commandOperatingPictureService, commandManagerActionService, commandOutcomeVerificationService, commandPlaybookIntelligenceService, commandShiftMemoryService, commandDataSourceTruthService, providerConnectionReadinessService, providerDataReconciliationService, providerIntegrationContinuityService, pilotDataAuthorityCutoverService, pilotRuntimeGuardrailService, pilotIncidentRecoveryCertificationService, pilotShiftCertificationService, livePilotShiftCommandService, livePilotEvidenceOutcomeLedgerService, pilotKpiBaselineValueMeasurementService, pilotPerformanceTrendIntelligenceService, pilotExecutiveReviewExpansionGateService, controlledExpansionLocationReadinessService, expansionLaunchCertificationActivationService, expansionStabilizationSupportControlService, multiLocationPortfolioGovernanceService, portfolioExceptionCommandService, portfolioDecisionAccountabilityService, executiveDecisionOutcomeIntelligenceService, portfolioLearningPlaybookIntelligenceService, playbookEvidenceLifecycleService, playbookGovernanceAuthorityService, intelligenceConsolidationService, architectureFreezeService, integrationReadinessService, connectorSyncReliabilityService, dataReconciliationConflictService, integrationHealthCommandService, integrationCertificationService, restaurantConfigurationService, pilotLocationConfigurationCertificationService, pilotDataWorkflowBindingService, pilotScenarioServiceSimulationService, pilotOperatorAcceptanceService, pilotReadinessLaunchControlService, pilotRuntimeSessionControlService, pilotRuntimeObservabilityIncidentService, pilotSessionCloseoutEvidenceService, pilotLearningNextSessionDecisionService, pilotOperatorCommandCenterService, pilotEnvironmentDeploymentReadinessService, pilotBackupRestoreRollbackReadinessService, pilotObservabilityAlertingSupportReadinessService, pilotSecurityAccessAuditReadinessService, pilotPerformanceCapacityResilienceReadinessService, pilotDeviceNetworkOnsiteContinuityReadinessService, pilotTrainingRunbookOperatorEnablementReadinessService, pilotFinalGoLiveLaunchAuthorizationService, pilotLaunchDayCommandControlService, pilotFirstServiceStabilizationHypercareService, pilotRepeatServiceReliabilityConfidenceService, pilotExitReadinessV96PreparationService, v96PilotReadyCertificationService, pilotBaselineLockCommercialHardeningService, commercialDefectFrictionRegressionControlService, commercialProductionReliabilitySupportabilityService, commercialDeploymentReleaseDisciplineService, livePilotFieldEvidenceService, pilotEvidenceQualityOutcomeMeasurementService, pilotValueProofOperatorAcceptanceService, pilotLearningProductDecisionControlService, commercialProductFreezeFinalHardeningService, finalRegressionSecurityDataIntegrityCertificationService, finalOperatorUxAccessibilityServiceReadinessService, commercialReleaseCandidateLockService, releaseCandidateEndToEndValidationService, commercialOperationsSupportReadinessService, finalGoNoGoV100ReleaseAuthorizationService, commercialV1CertificationService }) {
  return async function route(request, response) {
    ...
    const canWriteOperations = () =>
      authService.can(auth, "write") || authService.can(auth, "write_operations");
    ...
    if (url.pathname === "/api/commercial-release/v1-certification" && request.method === "GET") {
      if (!authService.can(auth,"admin")) return sendJson(response,403,{error:"Commercial V1 certification requires admin permission."});
      return sendJson(response,200,await commercialV1CertificationService.snapshot(auth.organizationId,auth.membership?.locationIds||[]));
    }
    if (url.pathname === "/api/commercial-release/v1-certification" && request.method === "POST") {
      if (!authService.can(auth,"admin")) return sendJson(response,403,{error:"Commercial V1 certification requires admin permission."});
      try { const body=await readJson(request); return sendJson(response,201,await commercialV1CertificationService.certify(auth.organizationId,auth.membership?.locationIds||[],body,auth.userId)); }
      catch(error){ return sendJson(response,400,{error:error.message}); }
    }

    if (url.pathname === "/api/commercial-release/v100-authorization" && request.method === "GET") {
      if (!authService.can(auth,"admin")) return sendJson(response,403,{error:"V100 release authorization requires admin permission."});
      return sendJson(response,200,await finalGoNoGoV100ReleaseAuthorizationService.snapshot(auth.organizationId,auth.membership?.locationIds||[]));
    }
    if (url.pathname === "/api/commercial-release/v100-authorization" && request.method === "POST") {
      if (!authService.can(auth,"admin")) return sendJson(response,403,{error:"V100 release authorization requires admin permission."});
      try {
        const body=await readJson(request);
        return sendJson(response,201,await finalGoNoGoV100ReleaseAuthorizationService.decide(auth.organizationId,auth.membership?.locationIds||[],body,auth.userId));
      } catch(error){ return sendJson(response,400,{error:error.message}); }
    }

    if (url.pathname === "/api/commercial-release/operations-support-readiness" && request.method === "GET") {
      if (!authService.can(auth,"admin")) return sendJson(response,403,{error:"Commercial operations and support readiness requires admin permission."});
      return sendJson(response,200,await commercialOperationsSupportReadinessService.snapshot(auth.organizationId,auth.membership?.locationIds||[]));
    }
    if (url.pathname === "/api/commercial-release/operations-support-readiness" && request.method === "POST") {
      if (!authService.can(auth,"admin")) return sendJson(response,403,{error:"Commercial operations and support readiness requires admin permission."});
      try {
        const body=await readJson(request);
        return sendJson(response,201,await commercialOperationsSupportReadinessService.record(auth.organizationId,auth.membership?.locationIds||[],body,auth.userId));
      } catch(error){ return sendJson(response,400,{error:error.message}); }
    }

    if (url.pathname === "/api/commercial-release/end-to-end-validation" && request.method === "GET") {
      if (!authService.can(auth,"admin")) return sendJson(response,403,{error:"Release candidate end-to-end validation requires admin permission."});
      return sendJson(response,200,await releaseCandidateEndToEndValidationService.snapshot(auth.organizationId,auth.membership?.locationIds||[]));
    }

    if (url.pathname === "/api/commercial-release/candidate-lock" && request.method === "GET") {
      if (!authService.can(auth,"admin")) return sendJson(response,403,{error:"Release candidate lock requires admin permission."});
      return sendJson(response,200,await commercialReleaseCandidateLockService.snapshot(auth.organizationId,auth.membership?.locationIds||[]));
    }
    if (url.pathname === "/api/commercial-release/candidate-lock" && request.method === "POST") {
      if (!authService.can(auth,"admin")) return sendJson(response,403,{error:"Release candidate lock requires admin permission."});
      try { const body=await readJson(request); return sendJson(response,201,await commercialReleaseCandidateLockService.lock(auth.organizationId,auth.membership?.locationIds||[],body,auth.userId)); }
      catch(error){return sendJson(response,400,{error:error.message});}
    }
    if (url.pathname === "/api/commercial-release/candidate-lock/blocker" && request.method === "POST") {
      if (!authService.can(auth,"admin")) return sendJson(response,403,{error:"Release candidate blockers require admin permission."});
      try { const body=await readJson(request); return sendJson(response,201,await commercialReleaseCandidateLockService.addBlocker(auth.organizationId,body,auth.userId)); }
      catch(error){return sendJson(response,400,{error:error.message});}
    }

    if (url.pathname === "/api/commercial-hardening/final-operator-readiness" && request.method === "GET") {
      if (!authService.can(auth,"admin")) return sendJson(response,403,{error:"Final operator readiness certification requires admin permission."});
      return sendJson(response,200,await finalOperatorUxAccessibilityServiceReadinessService.snapshot(auth.organizationId,auth.membership?.locationIds||[]));
    }

    if (url.pathname === "/api/commercial-hardening/final-technical-certification" && request.method === "GET") {
      if (!authService.can(auth,"admin")) return sendJson(response,403,{error:"Final technical certification requires admin permission."});
      return sendJson(response,200,await finalRegressionSecurityDataIntegrityCertificationService.snapshot(auth.organizationId,auth.membership?.locationIds||[]));
    }

    if (url.pathname === "/api/commercial-hardening/product-freeze" && request.method === "GET") {
      if (!authService.can(auth,"manager")) return sendJson(response,403,{error:"Commercial product freeze requires manager permission."});
      return sendJson(response,200,await commercialProductFreezeFinalHardeningService.snapshot(auth.organizationId,auth.membership?.locationIds||[]));
    }
    if (url.pathname === "/api/commercial-hardening/product-freeze" && request.method === "POST") {
      if (!authService.can(auth,"admin")) return sendJson(response,403,{error:"Commercial product freeze requires admin permission."});
      try { const body=await readJson(request); return sendJson(response,201,await commercialProductFreezeFinalHardeningService.freeze(auth.organizationId,auth.membership?.locationIds||[],body,auth.userId)); }
      catch(error){return sendJson(response,400,{error:error.message});}
    }
    if (url.pathname === "/api/commercial-hardening/product-freeze/exception" && request.method === "POST") {
      if (!authService.can(auth,"admin")) return sendJson(response,403,{error:"Commercial freeze exceptions require admin permission."});
      try { const body=await readJson(request); return sendJson(response,201,await commercialProductFreezeFinalHardeningService.addException(auth.organizationId,body,auth.userId)); }
      catch(error){return sendJson(response,400,{error:error.message});}
    }

    if (url.pathname === "/api/pilot/product-decisions" && request.method === "GET") {
      if (!authService.can(auth,"manager")) return sendJson(response,403,{error:"Pilot product decisions require manager permission."});
      return sendJson(response,200,await pilotLearningProductDecisionControlService.snapshot(auth.organizationId,auth.membership?.locationIds||[]));
    }
    if (url.pathname === "/api/pilot/product-decisions" && request.method === "POST") {
      if (!authService.can(auth,"admin")) return sendJson(response,403,{error:"Pilot product decision creation requires admin permission."});
      try { const body=await readJson(request); return sendJson(response,201,await pilotLearningProductDecisionControlService.record(auth.organizationId,auth.membership?.locationIds||[],body,auth.userId)); }
      catch(error){return sendJson(response,400,{error:error.message});}
    }
    if (url.pathname.startsWith("/api/pilot/product-decisions/") && url.pathname.endsWith("/close") && request.method === "POST") {
      if (!authService.can(auth,"admin")) return sendJson(response,403,{error:"Pilot product decision closeout requires admin permission."});
      try { const id=url.pathname.split("/")[4],body=await readJson(request); return sendJson(response,200,await pilotLearningProductDecisionControlService.close(auth.organizationId,id,body,auth.userId)); }
      catch(error){return sendJson(response,400,{error:error.message});}
    }

    if (url.pathname === "/api/pilot/value-proof-acceptance" && request.method === "GET") {
      if (!authService.can(auth,"manager")) return sendJson(response,403,{error:"Pilot value proof requires manager permission."});
      return sendJson(response,200,await pilotValueProofOperatorAcceptanceService.snapshot(auth.organizationId,auth.membership?.locationIds||[]));
    }
    if (url.pathname === "/api/pilot/value-proof-acceptance" && request.method === "POST") {
      if (!authService.can(auth,"manager")) return sendJson(response,403,{error:"Pilot operator acceptance requires manager permission."});
      try { const body=await readJson(request); return sendJson(response,201,await pilotValueProofOperatorAcceptanceService.record(auth.organizationId,auth.membership?.locationIds||[],body,auth.userId)); }
      catch(error){return sendJson(response,400,{error:error.message});}
    }

    if (url.pathname === "/api/pilot/evidence-quality-outcomes" && request.method === "GET") {
      if (!authService.can(auth,"manager")) return sendJson(response,403,{error:"Pilot evidence measurement requires manager permission."});
      return sendJson(response,200,await pilotEvidenceQualityOutcomeMeasurementService.snapshot(auth.organizationId,auth.membership?.locationIds||[]));
    }
    if (url.pathname.startsWith("/api/pilot/field-evidence/") && url.pathname.endsWith("/verify") && request.method === "POST") {
      if (!authService.can(auth,"manager")) return sendJson(response,403,{error:"Pilot evidence verification requires manager permission."});
      try { const id=url.pathname.split("/")[4]; return sendJson(response,200,await livePilotFieldEvidenceService.verify(auth.organizationId,id,auth.userId)); }
      catch(error){return sendJson(response,400,{error:error.message});}
    }

    if (url.pathname === "/api/pilot/field-evidence" && request.method === "GET") {
      if (!authService.can(auth,"manager")) return sendJson(response,403,{error:"Pilot field evidence requires manager permission."});
      return sendJson(response,200,await livePilotFieldEvidenceService.snapshot(auth.organizationId,auth.membership?.locationIds||[]));
    }
    if (url.pathname === "/api/pilot/field-evidence" && request.method === "POST") {
      if (!authService.can(auth,"manager")) return sendJson(response,403,{error:"Pilot field evidence requires manager permission."});
      try { const body=await readJson(request); return sendJson(response,201,await livePilotFieldEvidenceService.record(auth.organizationId,auth.membership?.locationIds||[],body,auth.userId)); }
      catch(error){return sendJson(response,400,{error:error.message});}
    }

    if (url.pathname === "/api/commercial-hardening/release-discipline" && request.method === "GET") {
      if (!authService.can(auth,"admin")) return sendJson(response,403,{error:"Commercial release discipline requires admin permission."});
      return sendJson(response,200,await commercialDeploymentReleaseDisciplineService.snapshot(auth.organizationId,auth.membership?.locationIds||[]));
    }
    if (url.pathname === "/api/commercial-hardening/release-discipline" && request.method === "POST") {
      if (!authService.can(auth,"admin")) return sendJson(response,403,{error:"Commercial release approval requires admin permission."});
      try { const body=await readJson(request); return sendJson(response,201,await commercialDeploymentReleaseDisciplineService.approve(auth.organizationId,auth.membership?.locationIds||[],body,auth.userId)); }
      catch(error){return sendJson(response,400,{error:error.message});}
    }

    if (url.pathname === "/api/commercial-hardening/production-supportability" && request.method === "GET") {
      if (!authService.can(auth,"manager")) return sendJson(response,403,{error:"Production supportability readiness requires manager permission."});
      return sendJson(response,200,await commercialProductionReliabilitySupportabilityService.snapshot(auth.organizationId,auth.membership?.locationIds||[]));
    }

    if (url.pathname === "/api/commercial-hardening/issues" && request.method === "GET") {
      if (!authService.can(auth,"manager")) return sendJson(response,403,{error:"Commercial hardening issue control requires manager permission."});
      return sendJson(response,200,await commercialDefectFrictionRegressionControlService.snapshot(auth.organizationId,auth.membership?.locationIds||[]));
    }
    if (url.pathname === "/api/commercial-hardening/issues" && request.method === "POST") {
      if (!authService.can(auth,"manager")) return sendJson(response,403,{error:"Commercial hardening issue control requires manager permission."});
      try {
        const body=await readJson(request);
        return sendJson(response,201,await commercialDefectFrictionRegressionControlService.record(auth.organizationId,body,auth.userId));
      } catch(error) { return sendJson(response,400,{error:error.message}); }
    }

    if (url.pathname === "/api/commercial-hardening/baseline-lock" && request.method === "GET") {
      if (!authService.can(auth,"admin")) return sendJson(response,403,{error:"Commercial-hardening baseline lock requires admin permission."});
      return sendJson(response,200,await pilotBaselineLockCommercialHardeningService.snapshot(auth.organizationId,auth.membership?.locationIds||[]));
    }

    if (url.pathname === "/api/pilot/v96-certification" && request.method === "GET") {
      if (!authService.can(auth,"admin")) return sendJson(response,403,{error:"V96 pilot-ready certification requires admin permission."});
      return sendJson(response,200,await v96PilotReadyCertificationService.snapshot(auth.organizationId,auth.membership?.locationIds||[]));
    }
    if (url.pathname === "/api/pilot/v96-certification" && request.method === "POST") {
      if (!authService.can(auth,"admin")) return sendJson(response,403,{error:"V96 pilot-ready certification requires admin permission."});
      try {
        const body=await readJson(request);
        const result=await v96PilotReadyCertificationService.certify(auth.organizationId,auth.membership?.locationIds||[],body,auth.userId);
        return sendJson(response,200,result);
      } catch(error) { return sendJson(response,400,{error:error.message}); }
    }

    if (url.pathname === "/api/pilot/v96-certification-preparation" && request.method === "GET") {
      if (!authService.can(auth,"admin")) return sendJson(response,403,{error:"V96 certification preparation requires admin permission."});
      return sendJson(response,200,await pilotExitReadinessV96PreparationService.current(auth.organizationId,auth.membership?.locationIds||[]));
    }

    if (url.pathname === "/api/pilot/repeat-service-confidence" && request.method === "GET") {
      if (!authService.can(auth,"manager")) return sendJson(response,403,{error:"Pilot repeat-service confidence requires manager permission."});
      return sendJson(response,200,await pilotRepeatServiceReliabilityConfidenceService.current(auth.organizationId,auth.membership?.locationIds||[]));
    }

    if (url.pathname === "/api/pilot/first-service-hypercare" && request.method === "GET") {
      if (!authService.can(auth,"manager")) return sendJson(response,403,{error:"Pilot first-service hypercare requires manager permission."});
      return sendJson(response,200,await pilotFirstServiceStabilizationHypercareService.current(auth.organizationId,auth.membership?.locationIds||[]));
    }

    if (url.pathname === "/api/pilot/launch-day-command" && request.method === "GET") {
      if (!authService.can(auth,"manager")) return sendJson(response,403,{error:"Pilot launch-day command requires manager permission."});
      return sendJson(response,200,await pilotLaunchDayCommandControlService.current(auth.organizationId,auth.membership?.locationIds||[]));
    }

    if (url.pathname === "/api/pilot/final-go-live-readiness" && request.method === "GET") {
      if (!authService.can(auth,"admin")) return sendJson(response,403,{error:"Final pilot go-live readiness requires admin permission."});
      return sendJson(response,200,await pilotFinalGoLiveLaunchAuthorizationService.current(auth.organizationId,auth.membership?.locationIds||[]));
    }

    if (url.pathname === "/api/pilot/operator-enablement-readiness" && request.method === "GET") {
      if (!authService.can(auth,"manager")) return sendJson(response,403,{error:"Pilot operator enablement readiness requires manager permission."});
      return sendJson(response,200,await pilotTrainingRunbookOperatorEnablementReadinessService.current(auth.organizationId,auth.membership?.locationIds||[]));
    }

    if (url.pathname === "/api/pilot/onsite-continuity-readiness" && request.method === "GET") {
      if (!authService.can(auth,"manager")) return sendJson(response,403,{error:"Pilot onsite continuity readiness requires manager permission."});
      return sendJson(response,200,await pilotDeviceNetworkOnsiteContinuityReadinessService.current(auth.organizationId,auth.membership?.locationIds||[]));
    }

    if (url.pathname === "/api/pilot/performance-readiness" && request.method === "GET") {
      if (!authService.can(auth,"manager")) return sendJson(response,403,{error:"Pilot performance readiness requires manager permission."});
      return sendJson(response,200,await pilotPerformanceCapacityResilienceReadinessService.current(auth.organizationId,auth.membership?.locationIds||[]));
    }

    if (url.pathname === "/api/pilot/security-readiness" && request.method === "GET") {
      if (!authService.can(auth,"admin")) return sendJson(response,403,{error:"Pilot security readiness requires admin permission."});
      return sendJson(response,200,await pilotSecurityAccessAuditReadinessService.current(auth.organizationId,auth.membership?.locationIds||[]));
    }

    if (url.pathname === "/api/pilot/support-readiness" && request.method === "GET") {
      if (!authService.can(auth,"manager")) return sendJson(response,403,{error:"Pilot support readiness requires manager permission."});
      return sendJson(response,200,await pilotObservabilityAlertingSupportReadinessService.current(auth.organizationId));
    }

    if (url.pathname === "/api/pilot/recovery-readiness" && request.method === "GET") {
      if (!authService.can(auth,"admin")) return sendJson(response,403,{error:"Pilot recovery readiness requires admin permission."});
      return sendJson(response,200,await pilotBackupRestoreRollbackReadinessService.current());
    }
    if (url.pathname === "/api/pilot/recovery-readiness/checkpoint" && request.method === "POST") {
      if (!authService.can(auth,"admin")) return sendJson(response,403,{error:"Creating a pilot recovery checkpoint requires admin permission."});
      const body=await readJsonBody(request);
      const result=await pilotBackupRestoreRollbackReadinessService.checkpoint(String(body.reason||"pilot-pre-change").slice(0,120));
      return sendJson(response,201,{ok:true,checkpoint:result});
    }

    if (url.pathname === "/api/pilot/environment-readiness" && request.method === "GET") {
      if (!authService.can(auth,"admin")) return sendJson(response,403,{error:"Pilot environment readiness requires admin permission."});
      return sendJson(response,200,await pilotEnvironmentDeploymentReadinessService.current());
    }
    ...
    if (url.pathname === "/api/pilot/learning-decisions" && request.method === "GET") {
      if (!authService.can(auth,"read") && !authService.can(auth,"admin")) return sendJson(response,403,{error:"Pilot learning decisions require read permission."});
      return sendJson(response,200,await pilotLearningNextSessionDecisionService.portfolio(organizationId));
    }
    if (url.pathname.startsWith("/api/pilot/learning-decision/") && url.pathname.endsWith("/assess") && request.method === "GET") {
      if (!authService.can(auth,"admin")) return sendJson(response,403,{error:"Pilot learning assessment requires admin permission."});
      const sessionId=url.pathname.split("/")[4];
      return sendJson(response,200,await pilotLearningNextSessionDecisionService.assess(organizationId,sessionId));
    }
    if (url.pathname.startsWith("/api/pilot/learning-decision/") && url.pathname.endsWith("/decide") && request.method === "POST") {
      if (!authService.can(auth,"admin")) return sendJson(response,403,{error:"Pilot next-session decision requires admin permission."});
      const sessionId=url.pathname.split("/")[4],body=await readJsonBody(request);
      return sendJson(response,201,await pilotLearningNextSessionDecisionService.decide(organizationId,sessionId,body,auth.user?.email||auth.user?.id||"operator"));
    }
    if (url.pathname.startsWith("/api/pilot/learning-decision/") && request.method === "GET") {
      if (!authService.can(auth,"read") && !authService.can(auth,"admin")) return sendJson(response,403,{error:"Pilot learning decision requires read permission."});
      const sessionId=url.pathname.split("/")[4];
      return sendJson(response,200,await pilotLearningNextSessionDecisionService.current(organizationId,sessionId));
    }
    ...
    if (url.pathname === "/api/manager-actions" && request.method === "POST") {
      if (!canWriteOperations()) return sendJson(response, 403, { error: "Manager action write permission required." });
      const body = await readJson(request);
    ...
    if (url.pathname === "/api/command-center/handoffs" && request.method === "POST") {
      if (!canWriteOperations()) return sendJson(response, 403, { error: "Command handoff write permission required." });
      const body = await readJson(request);
      const locationId = String(body.locationId || "").trim();
      if (!locationId) return sendJson(response, 400, { error: "Location is required." });
      if (!canAccessLocation(locationId)) return sendJson(response, 403, { error: "Location access denied." });
    ...
    if (url.pathname === "/api/scheduling" && request.method === "GET") {
      const locationId=String(url.searchParams.get("locationId")||"").trim(); if(!locationId)return sendJson(response,400,{error:"Location is required."}); if(!canAccessLocation(locationId))return sendJson(response,403,{error:"Location access denied."});
    ...
    if (url.pathname.startsWith("/api/workforce-foundation/employees/") && request.method === "PATCH") {
      ...
      const employee = await database.get("staff", id) || await database.get("employees", id);
    ...
    if (url.pathname === "/api/workforce-foundation/availability" && request.method === "POST") {
      const body = await readJson(request);
      const employee = await database.get("staff", body.employeeId) || await database.get("employees", body.employeeId);
      if (!employee || employee.organizationId !== organizationId || !canAccessLocation(employee.locationId)) return sendJson(response, 404, { error: "Employee not found." });
      const result = await workforceFoundationService.saveAvailability(body, auth.user.name, organizationId);
    ...
    if (url.pathname === "/api/workforce-foundation/pto" && request.method === "POST") {
      ...
      const employee = await database.get("staff", body.employeeId) || await database.get("employees", body.employeeId);
      if (!employee || employee.organizationId !== organizationId || !canAccessLocation(employee.locationId)) return sendJson(response, 404, { error: "Employee not found." });
      const result = await workforceFoundationService.requestPto(body, auth.user.name, organizationId);
    ...
    if (url.pathname.startsWith("/api/workforce-foundation/pto/") && request.method === "PATCH") {
      ...
      const id = decodeURIComponent(url.pathname.split("/").pop());
      const body = await readJson(request);
      const requestRecord = await database.get("ptoRequests", id);
      const employee = requestRecord ? (await database.get("staff", requestRecord.employeeId) || await database.get("employees", requestRecord.employeeId)) : null;
      if (!requestRecord || !employee || employee.organizationId !== organizationId || !canAccessLocation(employee.locationId)) return sendJson(response, 404, { error: "PTO request not found." });
    ...
    if (url.pathname === "/api/timeclock/clock-in" && request.method === "POST") {
      ...
      const employee = await database.get("employees", body.employeeId) || await database.get("staff", body.employeeId);
      if (!employee || employee.organizationId !== organizationId || !canAccessLocation(employee.locationId)) return sendJson(response, 404, { error: "Employee not found." });
    ...
    if (url.pathname === "/api/timeclock/clock-out" && request.method === "POST") {const body=await readJson(request),employeeId=String(body.employeeId||"").trim();if(!employeeId)return sendJson(response,400,{error:"Employee is required."});body.employeeId=employeeId;const employee=await database.get("employees",body.employeeId)||await database.get("staff",body.employeeId);if(!employee||employee.organizationId!==organizationId||!canAccessLocation(employee.locationId))return sendJson(response,404,{error:"Employee not found."});return sendJson(response,200,await timeClockService.clockOut(body,auth.user.name,organizationId));}
    ...
    if (url.pathname.startsWith("/api/timeclock/timecards/") && request.method === "PATCH") {
      ...
      const timecard = await database.get("employeeTimecards", timecardId);
      if (!timecard || timecard.organizationId !== organizationId || !canAccessLocation(timecard.locationId)) return sendJson(response, 404, { error: "Timecard not found." });
    ...
    if (url.pathname.startsWith("/api/inventory-intelligence/recommendations/") && request.method === "POST") {
      if (!canWriteOperations()) return sendJson(response,403,{error:"Inventory write permission required."});
    ...
    if (url.pathname.startsWith("/api/workforce-intelligence/recommendations/") && request.method === "POST") {
      if (!canWriteOperations()) return sendJson(response,403,{error:"Workforce intelligence write permission required."});
