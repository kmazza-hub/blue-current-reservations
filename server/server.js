...
const commandDataSourceTruthService = new CommandDataSourceTruthService(database, universalHospitalityIntegrationService, providerConnectionReadinessService);
