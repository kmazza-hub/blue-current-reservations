...
authService.initializePasswords().then(() => server.listen(PORT, () => {
  console.log(`Blue Current Cloud V58.50.0 running at http://localhost:${PORT}`);
