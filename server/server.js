...
authService.initializePasswords().then(() => server.listen(PORT, () => {
  console.log(`Blue Current Cloud V49.30.0 running at http://localhost:${PORT}`);
