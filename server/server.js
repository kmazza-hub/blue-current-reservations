...
authService.initializePasswords().then(() => server.listen(PORT, () => {
  console.log(`Blue Current Cloud V53.0.0 running at http://localhost:${PORT}`);
