...
authService.initializePasswords().then(() => server.listen(PORT, () => {
  console.log(`Blue Current Cloud V51.10.0 running at http://localhost:${PORT}`);
