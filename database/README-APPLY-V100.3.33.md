...
$upgrade = "$env:USERPROFILE\Downloads\BLUE-CURRENT-V100.3.33.zip"
$stage = Join-Path $env:TEMP "blue-current-v100.3.33"
...
npm install
npm run check
node .\scripts\maintenance\test-v100.3.33-frontline-mutation-response-integrity.js
...
git add .\server\api\router.js .\scripts\maintenance\test-v100.3.33-frontline-mutation-response-integrity.js .\V100.3.33-RELEASE.md .\README-APPLY-V100.3.33.md
git commit -m "V100.3.33 enforce frontline mutation response integrity"
