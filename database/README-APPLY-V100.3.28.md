...
$upgrade = "$env:USERPROFILE\Downloads\BLUE-CURRENT-V100.3.28.zip"
$stage = Join-Path $env:TEMP "blue-current-v100.3.28"
...
git add .\server\api\router.js .\scripts\maintenance\test-v100.3.28-core-operations-api-location-safety.js .\V100.3.28-RELEASE.md .\README-APPLY-V100.3.28.md
git commit -m "V100.3.28 enforce core operations API location safety"
