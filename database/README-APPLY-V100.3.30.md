...
$upgrade = "$env:USERPROFILE\Downloads\BLUE-CURRENT-V100.3.30.zip"
$stage = Join-Path $env:TEMP "blue-current-v100.3.30"
...
git add .\server\api\router.js .\server\services\workforceFoundationService.js .\scripts\maintenance\test-v100.3.30-frontline-labor-record-authorization.js .\V100.3.30-RELEASE.md .\README-APPLY-V100.3.30.md
git commit -m "V100.3.30 authorize frontline labor records"
