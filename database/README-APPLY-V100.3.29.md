...
$upgrade = "$env:USERPROFILE\Downloads\BLUE-CURRENT-V100.3.29.zip"
$stage = Join-Path $env:TEMP "blue-current-v100.3.29"
...
git add .\server\api\router.js .\server\services\inventoryIntelligenceService.js .\scripts\maintenance\test-v100.3.29-labor-inventory-api-location-safety.js .\V100.3.29-RELEASE.md .\README-APPLY-V100.3.29.md
git commit -m "V100.3.29 enforce labor and inventory API location safety"
