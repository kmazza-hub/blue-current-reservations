...
const testSrc=path.join(kit,'scripts/maintenance/test-v100.2.46-guest-recognition-memory.js');
const testDst=path.join(root,'scripts/maintenance/test-v100.2.46-guest-recognition-memory.js');fs.mkdirSync(path.dirname(testDst),{recursive:true});fs.copyFileSync(testSrc,testDst);
console.log('Applied V100.2.46 Guest Recognition & Hospitality Memory');
