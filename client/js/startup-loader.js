(() => {
  ...
  const appSource = `js/app-v15.1.3.js?v=42.38.0`;
  ...
  async function boot() {
    try {
      ...
      if (summary) summary.textContent = `V42.38.0 ready · ${duration}ms`;
