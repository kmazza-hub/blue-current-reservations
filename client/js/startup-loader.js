(() => {
  ...
  const appSource = `js/app-v15.1.3.js?v=40.41.0`;
  ...
  async function boot() {
    try {
      ...
      if (summary) summary.textContent = `V40.41.0 ready · ${duration}ms`;
