(() => {
  ...
  const appSource = `js/app-v15.1.3.js?v=42.2.0`;
  ...
  const PACK_RULES = {
    ...
    live: /(liveConnectorRuntime|canonicalEventGateway|liveSourceHealth)/i
  };
  ...
  async function boot() {
    try {
      ...
      if (summary) summary.textContent = `V42.2.0 ready · ${duration}ms`;
