(() => {
  ...
  const appSource = `js/app-v15.1.3.js?v=42.5.0`;
  ...
  const PACK_RULES = {
    ...
    live: /(liveConnectorRuntime|canonicalEventGateway|liveSourceHealth|eventContractRegistry|eventRecovery|liveOperationsBridge)/i
  };
  ...
  async function boot() {
    try {
      ...
      if (summary) summary.textContent = `V42.5.0 ready · ${duration}ms`;
