...
ready(()=>{
 ...
 window.addEventListener("offline",()=>toast("Connection lost. Live updates are paused until you’re back online.","warning",0));
 window.addEventListener("online",()=>toast("Connection restored. Live updates can resume.","success",3000));
