...
if ($CurrentVersion -ne "100.3.77") { throw "Expected certified V100.3.77; found V$CurrentVersion." }
...
$Files = @(
 "client\index.html", "client\styles.css", "client\js\focused-operator-workspaces-v100.3.9.js",
 "client\js\modules\hospitalityOsShell.js", "client\js\modules\productionReadiness.js", "package.json", "package-lock.json",
 ...
 "scripts\maintenance\certify-v100.3.76-live-audit-closure.js", "scripts\maintenance\certify-v100.3.77-focus-navigation-readiness-state.js",
 "scripts\maintenance\certify-v100.3.78-live-runtime-audit-closure.js", "INSTALL-V100.3.78.ps1", "README-V100.3.78.md"
)
...
npm ci
npm run check
if ($LASTEXITCODE -ne 0) { throw "V100.3.78 validation failed." }
npm run certify:pilot
if ($LASTEXITCODE -ne 0) { throw "V100.3.78 certification failed." }
...
Write-Host ""
Write-Host "V100.3.78 installed and certified." -ForegroundColor Green
