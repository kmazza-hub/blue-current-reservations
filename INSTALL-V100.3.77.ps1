...
if ($CurrentVersion -ne "100.3.76") { throw "Expected certified V100.3.76; found V$CurrentVersion." }
...
$Files = @(
 ...
 "scripts\maintenance\test-v100.3.77-focus-navigation-readiness-state.js", "scripts\maintenance\certify-v100.3.74-visible-sign-out.js",
 ...
 "scripts\maintenance\certify-v100.3.77-focus-navigation-readiness-state.js", "INSTALL-V100.3.77.ps1", "README-V100.3.77.md"
)
...
npm ci
npm run check
if ($LASTEXITCODE -ne 0) { throw "V100.3.77 validation failed." }
npm run certify:pilot
if ($LASTEXITCODE -ne 0) { throw "V100.3.77 certification failed." }
...
Write-Host ""
Write-Host "V100.3.77 installed and certified." -ForegroundColor Green
