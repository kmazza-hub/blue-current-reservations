...
if ($CurrentVersion -ne "100.3.69") { throw "Expected certified V100.3.69; found V$CurrentVersion." }
...
$Files = @(
  "client\index.html", "client\js\interaction-feedback-v64.0.js", "client\js\runtime-performance-v100.2.70.js",
  "client\js\network-connectivity-truth-v100.2.85.js", "package.json", "package-lock.json",
  ...
  "scripts\maintenance\certify-v100.3.70-post-login-connectivity.js",
  "INSTALL-V100.3.70.ps1", "README-V100.3.70.md"
)
...
npm ci
npm run check
if ($LASTEXITCODE -ne 0) { throw "V100.3.70 validation failed." }
npm run certify:pilot
if ($LASTEXITCODE -ne 0) { throw "V100.3.70 certification failed." }
...
Write-Host "";Write-Host "V100.3.70 installed and certified." -ForegroundColor Green
Write-Host "Runtime database preserved: $RuntimePath"
Write-Host "Restart Blue Current and hard-refresh the browser."
