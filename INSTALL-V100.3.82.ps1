...
if ($CurrentVersion -ne "100.3.81") { throw "Expected certified V100.3.81; found V$CurrentVersion." }
...
$Files = @(
 ...
 "INSTALL-V100.3.82.ps1", "README-V100.3.82.md"
)
...
npm ci
npm run check
if ($LASTEXITCODE -ne 0) { throw "V100.3.82 validation failed." }
npm run certify:pilot
if ($LASTEXITCODE -ne 0) { throw "V100.3.82 certification failed." }
...
Write-Host ""
Write-Host "V100.3.82 installed and certified." -ForegroundColor Green
