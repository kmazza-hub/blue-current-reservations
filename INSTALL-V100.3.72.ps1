...
if ($CurrentVersion -ne "100.3.71") { throw "Expected certified V100.3.71; found V$CurrentVersion." }
...
$Files = @(
  "client\index.html", "client\js\cloud\authSessionManager.js", "client\js\runtime-performance-v100.2.70.js",
  ...
  "scripts\maintenance\certify-v100.3.72-authenticated-readiness-continuity.js",
  "INSTALL-V100.3.72.ps1", "README-V100.3.72.md"
)
...
npm ci
npm run check
if ($LASTEXITCODE -ne 0) { throw "V100.3.72 validation failed." }
npm run certify:pilot
if ($LASTEXITCODE -ne 0) { throw "V100.3.72 certification failed." }
...
Write-Host "";Write-Host "V100.3.72 installed and certified." -ForegroundColor Green
