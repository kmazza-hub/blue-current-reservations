...
if ($CurrentVersion -ne "100.3.68") { throw "Expected certified V100.3.68; found V$CurrentVersion." }
...
$Files = @(
  ...
  "client\js\staff-workspace-runtime-v100.3.64.js", "server\services\schedulingService.js",
  ...
  "scripts\maintenance\certify-v100.3.69-workspace-reliability.js",
  "INSTALL-V100.3.69.ps1", "README-V100.3.69.md"
)
...
npm ci
npm run check
if ($LASTEXITCODE -ne 0) { throw "V100.3.69 validation failed." }
npm run certify:pilot
if ($LASTEXITCODE -ne 0) { throw "V100.3.69 certification failed." }
...
Write-Host "";Write-Host "V100.3.69 installed and certified." -ForegroundColor Green
