...
if ($CurrentVersion -ne "100.3.74") { throw "Expected certified V100.3.74; found V$CurrentVersion." }
...
$Files = @(
  ...
  "client\js\modules\hospitalityOsShell.js", "client\js\modules\productionReadiness.js",
  ...
  "scripts\maintenance\test-v100.3.72-authenticated-readiness-continuity.js",
  "scripts\maintenance\test-v100.3.73-render-runtime-marker-continuity.js",
  "scripts\maintenance\test-v100.3.74-visible-sign-out.js",
  "scripts\maintenance\test-v100.3.75-workspace-operating-truth-continuity.js",
  "scripts\maintenance\certify-v100.3.74-visible-sign-out.js",
  "scripts\maintenance\certify-v100.3.75-workspace-operating-truth-continuity.js",
  "INSTALL-V100.3.75.ps1", "README-V100.3.75.md"
)
...
npm ci
npm run check
if ($LASTEXITCODE -ne 0) { throw "V100.3.75 validation failed." }
npm run certify:pilot
if ($LASTEXITCODE -ne 0) { throw "V100.3.75 certification failed." }
...
Write-Host ""
Write-Host "V100.3.75 installed and certified." -ForegroundColor Green
