...
check("V100.3.68 assets are cache advanced",["100.3.68","100.3.69","100.3.70","100.3.71","100.3.72","100.3.73"].includes(pkg.version)&&/content="100\.3\.(?:69|70|71|72|73)"/.test(index)&&/live-defect-closure-v100\.3\.68\.js\?v=100\.3\.(?:69|70|71|72|73)/.test(index));
