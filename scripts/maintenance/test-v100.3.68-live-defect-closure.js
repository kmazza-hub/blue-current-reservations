...
check("V100.3.68 assets are cache advanced",["100.3.68","100.3.69","100.3.70"].includes(pkg.version)&&/content="100\.3\.(?:69|70)"/.test(index)&&/live-defect-closure-v100\.3\.68\.js\?v=100\.3\.(?:69|70)/.test(index));
