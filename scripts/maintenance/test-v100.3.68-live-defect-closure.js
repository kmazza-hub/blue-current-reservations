...
check("V100.3.68 assets are cache advanced",["100.3.68","100.3.69"].includes(pkg.version)&&index.includes('content="100.3.69"')&&index.includes('live-defect-closure-v100.3.68.js?v=100.3.69'));
