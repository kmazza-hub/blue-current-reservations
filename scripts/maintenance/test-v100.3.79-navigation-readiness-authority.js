...
check("Changed assets cross the V100.3.81 cache boundary",html.includes("focused-operator-workspaces-v100.3.9.js?v=100.3.81")&&html.includes("hospitalityOsShell.js?v=100.3.81")&&html.includes("productionReadiness.js?v=100.3.81"));
console.log(`V100.3.81 navigation and readiness authority ${passed}/${passed}`);
