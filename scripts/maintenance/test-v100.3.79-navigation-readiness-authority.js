...
check("Changed assets cross the V100.3.80 cache boundary",html.includes("focused-operator-workspaces-v100.3.9.js?v=100.3.80")&&html.includes("hospitalityOsShell.js?v=100.3.80")&&html.includes("productionReadiness.js?v=100.3.80"));
console.log(`V100.3.80 navigation and readiness authority ${passed}/${passed}`);
