...
check("Build advances to V100.3.79",pkg.version==="100.3.79"&&html.includes('content="100.3.79"'));
...
check("Navigation intent is retained during the settlement lease",/dataset\.bcWorkspaceIntent=name/.test(install));
...
check("Changed assets cross the V100.3.79 cache boundary",html.includes("focused-operator-workspaces-v100.3.9.js?v=100.3.79")&&html.includes("hospitalityOsShell.js?v=100.3.79")&&html.includes("productionReadiness.js?v=100.3.79"));
console.log(`V100.3.79 navigation and readiness authority ${passed}/${passed}`);
