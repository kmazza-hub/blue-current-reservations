...
(async()=>{
  ...
  check("Build retains V100.3.72 or later",["100.3.72","100.3.73","100.3.74","100.3.75","100.3.76","100.3.77","100.3.78","100.3.82"].includes(pkg.version)&&/content="100\.3\.(?:72|73|74|75|76|77|78|79|80|81|82)"/.test(html));
  check("Corrected session authority is cache advanced",/authSessionManager\.js\?v=100\.3\.(?:72|73|74|75|76|77|78|79|80|81|82)/.test(html));
