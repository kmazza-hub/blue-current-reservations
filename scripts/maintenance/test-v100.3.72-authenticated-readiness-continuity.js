...
(async()=>{
  ...
  check("Build retains V100.3.72 or later",["100.3.72","100.3.73","100.3.74"].includes(pkg.version)&&/content="100\.3\.(?:72|73|74)"/.test(html));
  check("Corrected session authority is cache advanced",/authSessionManager\.js\?v=100\.3\.(?:72|73|74)/.test(html));
