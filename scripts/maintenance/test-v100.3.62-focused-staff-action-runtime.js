...
check("Staff runtime loads module factories before its bootstrap",loader.indexOf("modules/workforceFoundation.js?v=100.3.62")<loader.indexOf("staff-operations-runtime-v100.3.62.js")&&loader.indexOf("modules/scheduling.js?v=100.3.62")<loader.indexOf("staff-operations-runtime-v100.3.62.js"));
...
check("V100.3.62 runtime and staff assets are cache-advanced",index.includes('content="100.3.62"')&&index.includes("runtime-performance-v100.2.70.js?v=100.3.62")&&loader.includes("staff-operations-runtime-v100.3.62.js?v=100.3.62"));
