...
check("Staff runtime loads module factories before its bootstrap",/modules\/workforceFoundation\.js\?v=100\.3\.(?:63|64|65|66)/.test(loader)&&/modules\/scheduling\.js\?v=100\.3\.(?:63|64|65|66)/.test(loader)&&loader.indexOf("modules/workforceFoundation.js")<loader.indexOf("staff-operations-runtime-v100.3.62.js"));
...
check("V100.3.62 runtime and staff assets remain cache-advanced",/content="100\.3\.(?:62|63|64|65|66)"/.test(index)&&/runtime-performance-v100\.2\.70\.js\?v=100\.3\.(?:62|63|64|65|66)/.test(index)&&/staff-operations-runtime-v100\.3\.62\.js\?v=100\.3\.(?:62|63|64|65|66)/.test(loader));
