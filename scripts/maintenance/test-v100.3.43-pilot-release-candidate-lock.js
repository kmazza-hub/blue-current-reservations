...
check("Package identifies the locked pilot candidate",pkg.version==="100.3.43");
...
check("One-command pilot certification is registered",pkg.scripts?.["certify:pilot"]==="node scripts/maintenance/certify-v100.3.43-pilot-release-candidate.js");
...
check("Certification manifest is readable and versioned",manifest?.release===pkg.version);
