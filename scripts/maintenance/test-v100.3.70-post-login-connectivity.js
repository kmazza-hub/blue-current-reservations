...
const checks=[
  ["Build retains V100.3.70 or later",["100.3.70","100.3.71"].includes(pkg.version)&&/content="100\.3\.(?:70|71)"/.test(html)],
  ...
  ["Corrected connectivity assets are cache advanced",/interaction-feedback-v64\.0\.js\?v=100\.3\.(?:70|71)/.test(html)&&/network-connectivity-truth-v100\.2\.85\.js\?v=100\.3\.(?:70|71)/.test(html)]
];
