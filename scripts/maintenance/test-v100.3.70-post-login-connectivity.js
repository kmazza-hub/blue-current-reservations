...
const checks=[
  ["Build advances to V100.3.70",pkg.version==="100.3.70"&&html.includes('content="100.3.70"')],
  ...
  ["Corrected connectivity assets are cache advanced",html.includes("interaction-feedback-v64.0.js?v=100.3.70")&&html.includes("network-connectivity-truth-v100.2.85.js?v=100.3.70")]
];
