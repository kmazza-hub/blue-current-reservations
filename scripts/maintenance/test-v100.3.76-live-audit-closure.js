...
check("Build retains V100.3.76 live-audit closure",["100.3.76","100.3.77"].includes(pkg.version)&&html.includes('content="100.3.77"'));
...
check("System initializes from the retained certified readiness",/let certifiedPilotReadiness = window\.BlueCurrentCertifiedPilotReadiness \|\|/.test(readiness) && /sessionStorage\.getItem\("bluecurrent\.certifiedPilotReadiness"\)/.test(readiness));
...
check("Changed runtime assets cross the V100.3.76 cache boundary",html.includes("styles.css?v=100.3.77")&&html.includes("hospitalityOsShell.js?v=100.3.77")&&html.includes("productionReadiness.js?v=100.3.77"));
