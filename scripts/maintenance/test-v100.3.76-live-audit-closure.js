...
check("Build retains V100.3.76 live-audit closure",["100.3.76","100.3.77","100.3.78","100.3.80"].includes(pkg.version)&&html.includes('content="100.3.80"'));
...
check("Changed runtime assets cross the V100.3.76 cache boundary",html.includes("styles.css?v=100.3.80")&&html.includes("hospitalityOsShell.js?v=100.3.80")&&html.includes("productionReadiness.js?v=100.3.80"));
