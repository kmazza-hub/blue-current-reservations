...
ok(src.includes('const VERSION="100.2.88"')||src.includes('const VERSION="100.2.89"')||src.includes('const VERSION="100.2.90"')||src.includes('const VERSION="100.2.91"'),"V100.2.88 resume lifecycle preserved or hardened");
