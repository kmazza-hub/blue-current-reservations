...
check("V100.3.66 runtime is cache advanced",pkg.version==="100.3.66"&&index.includes('content="100.3.66"')&&index.includes('staff-reliability-runtime-v100.3.66.js?v=100.3.66'));
