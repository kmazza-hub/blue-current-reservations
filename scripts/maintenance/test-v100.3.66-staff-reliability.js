...
check("V100.3.66 runtime is cache advanced",["100.3.66","100.3.67","100.3.68","100.3.69","100.3.70","100.3.71"].includes(pkg.version)&&/content="100\.3\.(?:66|67|68|69|70|71)"/.test(index)&&/staff-reliability-runtime-v100\.3\.66\.js\?v=100\.3\.(?:66|67|68|69|70|71)/.test(index));
