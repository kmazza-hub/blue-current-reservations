...
for(const script of ["scripts/maintenance/certify-v100.3.75-workspace-operating-truth-continuity.js","scripts/maintenance/test-v100.3.76-live-audit-closure.js"]){
...
console.log("\nV100.3.76 LIVE AUDIT CLOSURE CERTIFIED");
