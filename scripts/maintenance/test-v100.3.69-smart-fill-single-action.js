...
check("V100.3.69 assets are cache advanced",["100.3.69","100.3.70","100.3.71","100.3.72","100.3.73","100.3.74"].includes(pkg.version)&&/content="100\.3\.(?:69|70|71|72|73|74)"/.test(index)&&/staff-workspace-runtime-v100\.3\.64\.js\?v=100\.3\.(?:69|70|71|72|73|74)/.test(index));
