...
check("V100.3.57 floor assets are cache-advanced", /styles\.css\?v=100\.3\.(?:57|74)/.test(html) && html.includes('fullscreen-floor-clarity-v100.3.10.js?v=100.3.57') && html.includes('focused-operator-workspaces-v100.3.9.js?v=100.3.57'));
