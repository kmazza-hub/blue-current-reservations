...
check("Build retains certified V100.3.74 behavior", ["100.3.74","100.3.75","100.3.76","100.3.77"].includes(pkg.version) && html.includes('content="100.3.77"'));
...
check("Updated authentication assets cross a fresh cache boundary", html.includes("styles.css?v=100.3.77") && html.includes("authOrganizations.js?v=100.3.77"));
