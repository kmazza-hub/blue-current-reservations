...
check("Build retains certified V100.3.74 behavior", ["100.3.74","100.3.75","100.3.76","100.3.77","100.3.78","100.3.83"].includes(pkg.version) && html.includes('content="100.3.83"'));
...
check("Updated authentication assets cross a fresh cache boundary", html.includes("styles.css?v=100.3.83") && html.includes("authOrganizations.js?v=100.3.83"));
