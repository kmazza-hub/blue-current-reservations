...
check("Build advances to V100.3.74", pkg.version === "100.3.74" && html.includes('content="100.3.74"'));
...
check("Updated authentication assets cross a fresh cache boundary", html.includes("styles.css?v=100.3.74") && html.includes("authOrganizations.js?v=100.3.74"));

console.log(`V100.3.74 visible sign-out ${passed}/${passed}`);
