...
check("Build retains V100.3.78 or later",["100.3.78","100.3.81"].includes(pkg.version)&&html.includes('content="100.3.81"'));
...
check("All changed assets cross the V100.3.78 cache boundary",html.includes("styles.css?v=100.3.81")&&html.includes("focused-operator-workspaces-v100.3.9.js?v=100.3.81")&&html.includes("productionReadiness.js?v=100.3.81")&&html.includes("hospitalityOsShell.js?v=100.3.81"));
