...
check("Build retains V100.3.78 or later",["100.3.78","100.3.80"].includes(pkg.version)&&html.includes('content="100.3.80"'));
...
check("Shell has one capture-phase sidebar destination owner",(shell.match(/document\.addEventListener\("click"/g)||[]).length>=1&&/bcPrimaryNavigationOwner/.test(shell)&&/stopImmediatePropagation\(\)/.test(shell));
...
check("All changed assets cross the V100.3.78 cache boundary",html.includes("styles.css?v=100.3.80")&&html.includes("focused-operator-workspaces-v100.3.9.js?v=100.3.80")&&html.includes("productionReadiness.js?v=100.3.80")&&html.includes("hospitalityOsShell.js?v=100.3.80"));
