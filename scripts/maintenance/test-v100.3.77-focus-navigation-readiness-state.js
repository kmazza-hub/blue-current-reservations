...
check("Build retains V100.3.77 or later",["100.3.77","100.3.78"].includes(pkg.version)&&html.includes('content="100.3.78"'));
...
check("Changed focus and truth assets cross a fresh cache boundary",html.includes("focused-operator-workspaces-v100.3.9.js?v=100.3.78")&&html.includes("hospitalityOsShell.js?v=100.3.78")&&html.includes("productionReadiness.js?v=100.3.78")&&html.includes("styles.css?v=100.3.78"));
