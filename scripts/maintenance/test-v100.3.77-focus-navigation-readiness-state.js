...
check("Build retains V100.3.77 or later",["100.3.77","100.3.78","100.3.79"].includes(pkg.version)&&html.includes('content="100.3.79"'));
...
check("Shell remains the exclusive sidebar destination owner",/installPrimaryNavigation\(\)[\s\S]*navigation\.addEventListener\("click"/.test(shell)&&!/queueMicrotask\(commit\)/.test(focus));
...
check("Changed focus and truth assets cross a fresh cache boundary",html.includes("focused-operator-workspaces-v100.3.9.js?v=100.3.79")&&html.includes("hospitalityOsShell.js?v=100.3.79")&&html.includes("productionReadiness.js?v=100.3.79")&&html.includes("styles.css?v=100.3.79"));
