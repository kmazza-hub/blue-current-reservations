...
if ($CurrentVersion -notin @("100.3.60", "100.3.61", "100.3.62")) { throw "Expected V100.3.60, V100.3.61, or V100.3.62; found V$CurrentVersion." }
...
$ApplicationFiles = @(
    ...
    "client\js\staff-operations-runtime-v100.3.62.js",
    ...
    "scripts\maintenance\certify-v100.3.61-staff-coverage-operational-parity.js",
    "scripts\maintenance\test-v100.3.61-staff-coverage-operational-parity.js",
    "scripts\maintenance\certify-v100.3.62-focused-staff-action-runtime.js",
    "scripts\maintenance\test-v100.3.62-focused-staff-action-runtime.js",
    "INSTALL-V100.3.61.ps1", "README-V100.3.61.md",
    "INSTALL-V100.3.62.ps1", "README-V100.3.62.md"
)
...
npm ci
npm run check
if ($LASTEXITCODE -ne 0) { throw "V100.3.62 validation failed." }
npm run certify:pilot
if ($LASTEXITCODE -ne 0) { throw "V100.3.62 certification failed." }
...
Write-Host ""
Write-Host "V100.3.62 installed and certified." -ForegroundColor Green
Write-Host "Runtime database preserved: $RuntimePath"
Write-Host "Restart Blue Current, sign in as manager, and run the Staff Operations acceptance checklist."
