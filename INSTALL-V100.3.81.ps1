...
if ($CurrentVersion -ne "100.3.80") { throw "Expected certified V100.3.80; found V$CurrentVersion." }
...
$Files = @(
 ...
 "scripts\maintenance\test-v100.3.81-navigation-responsiveness.js",
 ...
 "scripts\maintenance\certify-v100.3.81-live-runtime-audit-closure.js",
 "INSTALL-V100.3.81.ps1", "README-V100.3.81.md"
)
...
npm ci
npm run check
if ($LASTEXITCODE -ne 0) { throw "V100.3.81 validation failed." }
npm run certify:pilot
if ($LASTEXITCODE -ne 0) { throw "V100.3.81 certification failed." }
...
Write-Host ""
Write-Host "V100.3.81 installed and certified." -ForegroundColor Green
