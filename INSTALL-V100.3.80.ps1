...
if ($CurrentVersion -ne "100.3.79") { throw "Expected certified V100.3.79; found V$CurrentVersion." }
...
$Files = @(
 ...
 "INSTALL-V100.3.80.ps1", "README-V100.3.80.md"
)
...
npm ci
npm run check
if ($LASTEXITCODE -ne 0) { throw "V100.3.80 validation failed." }
npm run certify:pilot
if ($LASTEXITCODE -ne 0) { throw "V100.3.80 certification failed." }
...
Write-Host ""
Write-Host "V100.3.80 installed and certified." -ForegroundColor Green
